...
_SOURCES: dict[str, NormRect] = {
    ...
    # 같은 화면, 같은 자리인데 성장 게이지가 다 차면 버튼이 바뀐다.
    #
    #     게이지 안 참   청록 '오븐 성장'   -> oven_grow
    #     게이지 다 참   주황 '레벨업!'     -> oven_grow_levelup
    #
    # 글자도 색도 바뀌므로 둘 다 둔다. 46x16 px.
    "oven_grow_levelup": NormRect(0.4354, 0.8561, 0.1214, 0.0237),
}
